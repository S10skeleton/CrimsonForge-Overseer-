  ...
  return (
    <div style={{
      ...
      <div className="mono" style={{
        ...
        fontSize: 10, letterSpacing: 2, color: 'var(--text-hint)',
      }}>
        CRIMSONFORGE // OPS
      </div>
      ...
      <div style={{
        ...
        {/* Identity */}
        <div style={{ fontWeight: 800, fontSize: 18, letterSpacing: 10, marginBottom: 6, color: 'var(--text-primary)' }}>
          ELARA
        </div>
        ...
        <div style={{
          ...
          <div style={{ padding: '24px 24px 22px' }}>
            ...
            {locked ? (
              <div style={{ textAlign: 'center', padding: '16px 0' }}>
                <div style={{ fontWeight: 800, fontSize: 34, color: 'var(--red-text)', marginBottom: 8 }}>
                  {fmt(lockCountdown)}
                </div>
              ...
              <>
                <input
                  ...
                  disabled={loading}
                  style={{
                    marginBottom: 12, letterSpacing: 3, fontSize: 16,
                    borderColor: error ? 'var(--red-text)' : undefined,
                  }}
                />

                {error && (
                  <div style={{ fontSize: 12, color: 'var(--red-text)', marginBottom: 10, letterSpacing: .2, lineHeight: 1.5, textAlign: 'left' }}>
                    {error}
                  </div>
                )}
          ...
          <div style={{
            ...
            <span className="mono" style={{ fontSize: 9, color: 'var(--text-hint)', letterSpacing: 1 }}>
              AES-256 // EPHEMERAL
            </span>
            <span className="mono" style={{ fontSize: 9, color: 'var(--text-hint)', letterSpacing: 1 }}>
              v0.4.0
